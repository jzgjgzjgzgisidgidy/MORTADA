...
'caption'=>"*᥀︙أهلآ بك* [$name](tg://user?id=$from_id) *أنا بوت 
᥀︙وظيفتي حماية القنوات والمجموعات
᥀︙أضِف البوت إلى قناتك او مجموعتك
᥀︙ارفعه مشرف
᥀︙ثم ارسل تفعيل
᥀︙البوت لا يعمل بدون صلاحية اضافة مشرفين*
––––––––
- مبرمج البوت - @M_R_Q_P",
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'- اوامر .' ,'callback_data'=>"cmd"]],
[['text'=>'- حول .' ,'callback_data'=>"info"],['text'=>". Chaneel -",'url'=>"t.me/I_I_T7"]],
[['text'=>"- ضيفني لقناتك .",'url'=>"https://t.me/GEIEZBot?startchannel"]],
]])]);}
if($data == "back" ){
...
'message_id'=>$message_id2,
'photo' =>"https://t.me/gey9e/63",
'caption'=>'*┏━━❍ 𝗆𝖸 𝗂َِ𝗇𝖿َ𝗈َ𝗋َِ𝗆َ𝖺َِ𝗍𝗂َ𝗈َِ𝗇 ❍━━┓
┃                                                      
╟◈  َِ𝗇َ𝖺َِ𝗆َِ𝖾  :* [MORTADA](tg://user?id=1427981991)
*┃                                                  
╟◈  َِ𝖼َ𝗈َ𝗎َِ𝗇َِ𝗍َ𝗋َِ𝖾   :   𝗂َ𝗋َ𝖺َِ𝖰 🇮🇶
┃  
╟◈  َِِۢ𝖼𝗁َ𝖺َِ𝗇َِ𝗇َِ𝖾َ𝗅   : @I_I_T7
┃
╟◈  َ𝗎َِ𝖲َِ𝖾َ𝗋َِ𝗇َ𝖺َِ𝗆َِ𝖾 : @M_R_Q_P 
┃             
┗━━━━━━━━━━━━━━━━━┛*',
'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
...
᥀︙لتفعيل البوت قم برفعه ادمن في القناه واعطاءه كل الصلاحيات.
᥀︙وارسل تفعيل في القناه .
᥀︙لاتستخدم وضع التخفي .

᥀︙لرفع الادمن في القناه قم بأرسال
––––––––
- مبرمج البوت - @M_R_Q_P
• /admin + ايدي العضو
• /admin 1427981991*',
